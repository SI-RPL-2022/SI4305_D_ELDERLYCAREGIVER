...
<title>Chat Pengasuh | Elderly Caregiver</title>
					...
					<div class="py-2 px-4 border-bottom d-none d-lg-block">
						<div class="d-flex align-items-center py-1">
							...
							<div class="flex-grow-1 pl-3">
								<strong>User</strong>
								<div class="text-muted small"><em>Sedang mengetik...</em></div>
							</div>
							<div>
						...
						<div class="chat-messages p-4">
							...
							<div class="chat-message-left pb-4">
								...
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
									<div class="mb-1" style="font-weight: bold">User</div>
                            ...
                            <div class="flex-grow-0 py-3 px-4 mb-4 border-top">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Masukkan pesan">
