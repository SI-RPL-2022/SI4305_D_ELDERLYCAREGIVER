...
@push('scripts')
    ...
    const loadlocations = (geoJson) => {
        geoJson.features.forEach((location) => {
            ...
            const {iconSize, locationId, alamat} = properties

            let markerElement = document.createElement('div')
            markerElement.className = 'marker'
            markerElement.id = locationId
            markerElement.style.backgroundImage = 'url(https://w7.pngwing.com/pngs/96/625/png-transparent-marker-cross-red-cross-medicine-symbol-dead-death-cemetery-united-states.png)'
